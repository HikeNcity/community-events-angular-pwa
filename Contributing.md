# Contributing to CommunityEvents
...
In short, when you submit code changes, your submissions are understood to be under the same [muhammadawaisshaikh](https://github.com/muhammadawaisshaikh) that covers the project. Feel free to contact the maintainers if that's a concern.
...
## License
By contributing, you agree that your contributions will be for @muhammadawaisshaikh.
